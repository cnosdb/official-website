...
export default function Home(): JSX.Element {
  ...
  const Content = ({ platform, content }) => {
    if (platform === 'eco') {
      return (
        <div>
          <p>我们集成了社区中常用的工具，您可以通过查看 <a href="https://docs.cnosdb.com/zh/latest/versatility/" target="_blank"
            rel="noopener noreferrer">官方文档</a>获取更多和 CnosDB 结合使用的案例。</p>
          <p><a href="https://docs.influxdata.com/telegraf/v1.26/" target="_blank"
            rel="noopener noreferrer">Telegraf</a>：是一个开源的数据收集代理，可用于收集和发送各种类型的数据到 CnosDB 数据库中，方便进行数据分析和监控。 </p>
          <p><a href="https://grafana.com/" target="_blank"
            rel="noopener noreferrer">Grafana</a>：是一个开源的数据可视化工具，实现数据可视化和监控功能。</p>
          <p><a href="https://prometheus.io/" target="_blank" rel="noopener noreferrer">Prometheus</a>：是一个开源的监控系统，可以与 CnosDB 数据库结合使用，实现数据监控和告警功能。</p>
          <p><a href="https://www.tensorflow.org/" target="_blank"
            rel="noopener noreferrer">TensorFlow</a>：是一个开源的机器学习框架，实现对大规模数据的分析和处理，提高数据挖掘和机器学习的效率和精度。</p>
          <p><a href="https://python.langchain.com/docs/integrations/providers/cnosdb" target="_blank"
            rel="noopener noreferrer">LangChain</a>：使用LangChain的，可以构建具有上下文感知和推理功能的应用程序。</p>
          <p><a href="https://www.guandata.com/" target="_blank"
            rel="noopener noreferrer">观远BI</a>：使用观远BI，与CnosDB结合，快速进行物联网决策。</p>
          <p><a href="https://www.emqx.io/" target="_blank"
            rel="noopener noreferrer">EMQX</a>：大规模分布式 MQTT消息服务器，无缝集成 CnosDB。</p>
          <p><a href="https://kafka.apache.org/" target="_blank"
            rel="noopener noreferrer">Kafka</a>：最流行的消息中间件，无缝集成大数据平台。</p>
          <p><a href="https://vector.dev/" target="_blank"
            rel="noopener noreferrer">Vector</a>：一个轻量级、超快速的工具，用于构建可观测性流水线。</p>
          <p>点此处下载第三方生态组件的安装包：</p>
          <p><a href="https://docs.influxdata.com/telegraf/v1.26/install/" target="_blank"
            rel="noopener noreferrer">Telegraf</a> <a href="https://grafana.com/grafana/download" target="_blank"
              rel="noopener noreferrer">Grafana</a> <a href="https://prometheus.io/download/" target="_blank"
                rel="noopener noreferrer">Prometheus</a> <a href="https://www.tensorflow.org/install" target="_blank"
                  rel="noopener noreferrer">TensorFlow</a> <a href="https://python.langchain.com/docs/integrations/providers/cnosdb" target="_blank"
                    rel="noopener noreferrer">LangChain</a> <a href="https://www.guandata.com/" target="_blank"
                      rel="noopener noreferrer">观远BI</a> <a href="https://www.emqx.io/" target="_blank"
                        rel="noopener noreferrer">EMQX</a> <a href="https://kafka.apache.org/" target="_blank"
                          rel="noopener noreferrer">Kafka</a> <a href="https://vector.dev/" target="_blank"
      ...
      <main>
        <div className="header">
          <div className="download-inner-container">
            <h1 className="headerTitle">欢迎下载试用</h1>
            <p className="headerDesc">性能强，超稳定，还开源~ CnosDB，快来下载吧</p>
            <p className="headerDesc">如需使用企业版，请<a href="https://docs.cnosdb.com/docs/enterprise/">点击此处</a>&lt;&lt;</p>
          </div>
        </div>
        <Container>
