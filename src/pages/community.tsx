        ...
        <div className={styles.header}>
          <div className={styles.innerContainer}>
            <h1 className={styles.headerTitle}>
              <span>Ciao, Welcome to the<br />CnosDB Community! <span className={styles.spacerInner}></span></span>
              <div className={styles.iconsWrapper}>
                <a className={styles.headerIcon} href="https://github.com/cnosdb/cnosdb" target="_blank">
                ...
                <a className={styles.headerIcon} href="https://stackoverflow.com/questions/tagged/cnosdb" target="_blank">
                ...
                <a className={styles.headerIcon} href="https://twitter.com/cnosdb" target="_blank">
                ...
                <a className={styles.headerIcon} href="https://www.linkedin.com/company/cnosdb" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path>
                  </svg>
                </a>
                <a className={styles.headerIcon} href="https://discord.com/invite/D8cB4WGpP4" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <a className={styles.headerIcon} href="http://www.youtube.com/channel/UCSyEwkDbf1Py0JX0onjkD_A" target="_blank">
            ...
            <img className={styles.headerImg} src="https://cnosdb.com/wp-content/uploads/2022/06/undraw_google_docs_re_evm3_复制.svg" alt="" />
          </div>
        </div>
        <div className={styles.innerContainer}>
